...
.stats-row {
    ...
    @include md-down { grid-template-columns: 1fr; }
}
...
.quote-card {
    ...
    @include md-down { padding: 40px 24px; }
}

.quote-icon { font-size: 32px; color: $coral; margin-bottom: 20px; }
...
.principles-row {
    ...
    @include lg-down { grid-template-columns: repeat(2, 1fr); }
